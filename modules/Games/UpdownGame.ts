...
// import { UserType } from "messangerbot/types";
// import { CommandType } from "messangerbot/types";
...
//USE events.receiveSpecificCommand instead
// events.receiveCommand.on((obj)=> {
...
//     else if (UpdownGame.commands.includes(cmd)) {
//         UpdownGames[userHash] = new UpdownGame(obj, [user]);
//     };
// });